...
/**
 * User avatar component — shows profile photo or initials fallback.
 * Declared outside DashboardLayout to avoid re-creation on every render.
 *
 * @param {{ user: Object, size: string, textSize: string }} props
 */
