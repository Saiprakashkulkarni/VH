  ...
  useEffect(() => {
    const fetchChecklist = async () => {
      try {
        ...
        // Checklist remains empty; user sees loading shimmer then empty state
      }
      setLoading(false);
    };
...
SmartChecklist.propTypes = {
  /** Callback fired whenever checklist progress changes, receives the progress object */
