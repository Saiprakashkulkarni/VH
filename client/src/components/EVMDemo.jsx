 ...
 * Walks the user through the full voting process: intro → vote → VVPAT → done.
 * Uses realistic candidate data in the format used by the Election Commission of India.
 */
