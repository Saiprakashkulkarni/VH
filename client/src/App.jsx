...
/**
 * Full-screen loading overlay shown during auth verification and initial load.
...
ProtectedRoute.propTypes = {
  /** Route content to render when the user is authenticated and profile is complete */
...
AuthRequired.propTypes = {
  /** Route content to render when the user is authenticated */
  children: PropTypes.node.isRequired,
};
